      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <div className="mb-4 rounded-xl overflow-hidden" style={{ width: 180, height: 120 }}>
              <Image
                src="/logo.png"
          ...
          {/* Quick links */}
          <div>
            <h3 className="text-white font-bold text-sm uppercase tracking-widest mb-4" style={{ fontFamily: "var(--font-heading, Georgia, serif)" }}>
              Quick Links
            </h3>
            <ul className="space-y-2" style={{ fontFamily: "var(--font-body, sans-serif)" }}>
              {[
                { label: "Home", href: "/" },
          ...
          <div>
            ...
            <address className="not-italic space-y-3 text-sm text-white/70 leading-relaxed" style={{ fontFamily: "var(--font-body, sans-serif)" }}>
              ...
              <a
                ...
                className="inline-flex items-center gap-2 mt-1 px-4 py-2 bg-forest-light text-white text-xs font-semibold rounded hover:bg-forest transition-colors"
              >
        ...
        <div className="mt-10 pt-6 border-t border-white/10 text-center text-white/40 text-xs" style={{ fontFamily: "var(--font-body, sans-serif)" }}>
