    ...
    <>
      ...
      <section className="bg-navy text-white py-16 md:py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            Enrol at <span className="text-maroon">Shree Excellence.</span>
          </h1>
          <p
            className="mt-4 text-white/70 max-w-xl text-lg leading-relaxed"
            style={{ fontFamily: "var(--font-body, sans-serif)" }}
          >
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-3 lg:grid-cols-5 gap-6">
            {GRADES.map(({ grade, color, note }) => (
              <div
                key={grade}
                className="bg-white rounded-xl overflow-hidden border border-cream-dark hover:shadow-md transition-shadow"
              >
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {BOARDS.map(({ color, board, desc }) => (
              <div
                key={board}
                className="flex gap-5 p-7 rounded-xl bg-cream border border-cream-dark"
              >
                <div
          ...
          <p
            className="mt-6 text-warm-gray/70 text-sm italic"
            style={{ fontFamily: "var(--font-body, sans-serif)" }}
          >
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {STEPS.map(({ num, color, title, body }) => (
              <div key={num} className="relative">
                ...
                />
                <div
                  className="w-12 h-12 rounded-xl flex items-center justify-center font-extrabold text-white text-sm mb-4 relative z-10"
        ...
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          >
            <a
              ...
              className="px-7 py-3.5 bg-white text-maroon font-bold rounded-lg hover:bg-cream transition-colors shadow"
            >
              WhatsApp to Enrol
            </a>
            <a
